...
DBI::dbWriteTable(NBAdb, "GameLogsTeam", dataGameLogsTeam, append = T) # Daily
DBI::dbWriteTable(NBAdb, "GameLogsPlayer", dataGameLogsPlayer, append = T) # Daily
DBI::dbWriteTable(NBAdb, "PlayerDictionary", df_nba_player_dict, overwrite = T) # Daily
DBI::dbWriteTable(NBAdb, "PlayerAdvanced", dataBREFPlayerAdvanced, append = T) # Daily
DBI::dbWriteTable(NBAdb, "PlayerTotals", dataBREFPlayerTotals, append = T) # Daily
DBI::dbWriteTable(NBAdb, "PlayerPerGame", dataBREFPlayerPerGame, append = T) # Daily
# DBI::dbWriteTable(NBAdb, "TeamShots", TeamShots, append = T) # Monthly
# DBI::dbWriteTable(NBAdb, "PlayerProfiles", players, append = T) # Monthly
# DBI::dbWriteTable(NBAdb, "PlayByPlay", play_logs_all, append = T) # Monthly
# DBI::dbWriteTable(NBAdb, "BoxScorePlayer", dataBoxScorePlayerNBA, append = T) # Monthly
# DBI::dbWriteTable(NBAdb, "BoxScoreTeam", dataBoxScoreTeamNBA, append = T) # Monthly
# DBI::dbWriteTable(NBAdb, "TeamDictionary", team_dict, overwrite = T) # Monthly
# DBI::dbWriteTable(NBAdb, "BasicBoxScoreBREF", master_fic) # Monthly
# DBI::dbWriteTable(NBAdb, "AdvancedBoxScoreBREF", master_vorp) # Monthly
# DBI::dbWriteTable(NBAdb, "GamesBREF", df) # Monthly
